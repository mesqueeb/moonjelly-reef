...
./tracker.sh issue list --json number,title,labels --limit 100 \
  --search 'label:to-slice OR label:to-await-waves OR label:to-implement OR label:to-research OR label:to-inspect OR label:to-rework OR label:to-merge OR label:to-seal'
```
