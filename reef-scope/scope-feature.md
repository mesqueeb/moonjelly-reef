...
Then interview the diver relentlessly about every aspect of this plan until reaching a shared understanding. Walk down each branch of the design tree, resolving dependencies between decisions one-by-one.
...
Check with the diver that these modules match their expectations. Check with the diver which modules they want tests written for.
